...
def object_mode(xmin, xmax, ymin, ymax, xn, yn, itermax, horizon=2.0):
    # Adapted from
...
def object_mode_parallel(xmin, xmax, ymin, ymax, xn, yn, itermax, horizon=2.0):
    # Adapted from
    # https://thesamovar.wordpress.com/2009/03/22/fast-fractals-with-python-and-numpy/
    Xi, Yi = np.mgrid[0:xn, 0:yn]
    X = np.linspace(xmin, xmax, xn, dtype=np.float64)[Xi]
...
@nb.jit(nopython=True, parallel=False, fastmath=True)
def nopython_mode(xmin, xmax, ymin, ymax, xn, yn, itermax, horizon=2.0):
    # Adapted from
    # https://thesamovar.wordpress.com/2009/03/22/fast-fractals-with-python-and-numpy/
    # Xi, Yi = np.mgrid[0:xn, 0:yn]
    # X = np.linspace(xmin, xmax, xn, dtype=np.float64)[Xi]
