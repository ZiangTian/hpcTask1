...
if __name__ == "__main__":
    ...
    # Initialization
    xmin, xmax, xn = -2.25, +0.75, int(300/3)
    ymin, ymax, yn = -1.25, +1.25, int(300/3)
    maxiter = np.int64(200)

    # First execution
    mandelbrot(xmin, xmax, ymin, ymax, xn, yn, maxiter)
    
    # Benchmark
    time = timeit.repeat("mandelbrot(xmin, xmax, ymin, ymax, xn, yn, maxiter)",
