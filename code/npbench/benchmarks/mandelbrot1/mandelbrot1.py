...
# pythran_arg_str = "xmin, xmax, ymin, ymax, xn, yn, maxiter, 2.0"

# # Setup string
# numpy_setup_str = "pass"
# numba_setup_str = "pass"
# dace_setup_str = "pass"
# pythran_setup_str = "pass"
...
# pythran_report_str = "Pythran"


if __name__ == "__main__":

    parser = argparse.ArgumentParser()
    parser.add_argument("-f", "--framework", type=str, nargs="?", default="cupy")
    ...
    #         try:
    #             from mandelbrot1_numpy import mandelbrot as np_impl
